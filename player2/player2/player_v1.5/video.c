...
double get_frame_pts(PlayerState *ps, AVFrame *pframe)
{
    ...
    printf("video pst=%f-timebase=%d/%d-q2d=%f\n",pts,ps->pvideo_stream->time_base.num,ps->pvideo_stream->time_base.den,av_q2d(ps->pvideo_stream->time_base));
