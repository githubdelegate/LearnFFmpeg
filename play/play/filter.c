...
//        //wchar_t *cam = L"video=YY����";
//        //char *device_name_utf8 = dup_wchar_to_utf8(cam);
//        //wchar_t *cam_a = L"audio=���˷����� (Realtek High Definition Audio)";
...
//        {
//            printf("Could not open video codec.���޷��򿪽�������\n");
//            return -1;
//        }
//        //input audio initialize
//        if (avformat_find_stream_info(ifmt_ctx_a, NULL) < 0)
//        {
//            printf("Couldn't find audio stream information.���޷���ȡ����Ϣ��\n");
//            return -1;
//        }
//        audioindex = -1;
...
//        if (audioindex == -1)
//        {
//            printf("Couldn't find a audio stream.��û���ҵ���Ƶ����\n");
//            return -1;
//        }
...
//        {
//            printf("Could not open audio codec.���޷��򿪽�������\n");
//            return -1;
//        }
//        
//        //output initialize
...
//        if (!pCodec){
//            printf("Can not find output video encoder! (û���ҵ����ʵı�������)\n");
//            return -1;
//        }
...
//            printf("Failed to open output video encoder! (����������ʧ�ܣ�)\n");
//            return -1;
//        }
//        
...
//        if (!pCodec_a){
//            printf("Can not find output audio encoder! (û���ҵ����ʵı�������)\n");
//            return -1;
//        }
...
//            printf("Failed to open ouput audio encoder! (����������ʧ�ܣ�)\n");
//            return -1;
//        }
//        
//        //Add a new stream to output,should be called by the user before avformat_write_header() for muxing
